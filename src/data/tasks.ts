...
export const tasks: Task[] = [
  ...
  // Today
  {
    ...
    status: "done",
    priority: "high",
    description: "Robinhood-style dark theme, live data, kanban boards, living team portrait",
  },
  {
    id: "a-002",
    ...
    status: "done",
    priority: "high",
    description: "Multi-asset momentum strategy, floor protection, 60-day book plan. Both Alpaca accounts connected.",
  },
  {
    id: "a-003",
