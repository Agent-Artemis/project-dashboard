...
export const tasks: Task[] = [
  ...
  {
    id: "a-022",
    title: "Paper trade 3-day validation (Mon-Wed)",
    assignee: "artemis",
    board: "agent",
    column: "this-week",
    status: "not-started",
    priority: "high",
    description: "Test strategy with $100K paper account. Stocks + crypto. Document every trade.",
  },
  {
    id: "a-023",
    title: "Go live with $300 trading account",
    assignee: "artemis",
    board: "agent",
    column: "this-week",
    status: "not-started",
    priority: "high",
    description: "After 3 days paper validation. No leverage. 20% profit ratchet. Never lose basis.",
  },
