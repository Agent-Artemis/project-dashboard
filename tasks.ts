...
// Last updated: 2026-05-17 06:00 UTC (12:00 AM MDT)
// Nightly cleanup run completed: 2026-05-17 06:00 UTC
...
export const TASKS: Task[] = [
  // CRITICAL BLOCKERS (P0)
  {
    ...
    description:
      "Voice AI Platform parked April 16. Re-evaluation deadline (May 1) is now 15 days overdue. Decision required ASAP.",
    priority: "P0",
    status: "blocked",
    ...
    notes:
      "Options: (A) Re-activate client hunt (build sales playbook, Benny + Dennis), (B) Keep waiting (passive), (C) Drop entirely. Product: Retell AI voice agents. ROI depends on first client validation. NOW 16 DAYS OVERDUE.",
    owner: "Jeff",
  ...
  },
  {
    ...
    description:
      "Strategy documented, scripts pending execution. Re-evaluation deadline (May 1) is 15 days overdue.",
    priority: "P0",
    status: "blocked",
    category: "waiting-on-jeff",
    ...
    updatedAt: "2026-05-17T06:00:00Z",
    notes:
      "Options: (A) Build scripts + launch (5-7 day sprint, target 100 videos by May 31), (B) Deprioritize vs 9 active projects, (C) Drop. Two-channel strategy in knowledge/projects/. NOW 16 DAYS OVERDUE.",
    owner: "Jeff",
    tags: ["parked", "overdue", "decision-required"],
  },
  {
    ...
    description:
      "503B compliance arbitrage research complete. Parked April 11, re-eval deadline (May 1) now 15 days overdue.",
    priority: "P0",
    status: "blocked",
    category: "waiting-on-jeff",
    ...
    updatedAt: "2026-05-17T06:00:00Z",
    notes:
      "Options: (A) Resume hunt (contact dealers, brokers, scout distressed), (B) Keep parked, (C) Drop. Estimated $10M+ opportunity. Capital-intensive but huge upside. NOW 16 DAYS OVERDUE.",
    owner: "Jeff",
    tags: ["parked", "overdue", "decision-required"],
  },
  {
    ...
    description:
      "2 LinkedIn drafts pending for 35+ days (since April 12). This unblocks Healthcare Playbook conversion funnel.",
    priority: "P0",
    status: "open",
    category: "waiting-on-jeff",
    ...
    updatedAt: "2026-05-17T06:00:00Z",
    notes:
      "Jeff posts 2 drafts → Calculator + Playbook conversion funnel activated. Target: 10+ downloads by May 17. $0 revenue for 45 days depends on this. NOW 7 DAYS OVERDUE.",
    owner: "Jeff",
  ...
  },
  {
    ...
    description:
      "augeoagency-site.vercel.app deployed 36+ days ago. GoDaddy DNS not updated. Blocking brand site launch.",
    priority: "P0",
    status: "open",
    category: "waiting-on-jeff",
    ...
    updatedAt: "2026-05-17T06:00:00Z",
    notes:
      "GoDaddy creds in TOOLS.md. Nameserver: vercel.com. Low revenue impact but brand activation ready. NOW 7 DAYS OVERDUE.",
    owner: "Jeff",
...
export const STATS = {
  ...
  lastSyncedAt: "2026-05-17T06:00:00Z",
  lastCleanupRun: "2026-05-17T06:00:00Z",
};
